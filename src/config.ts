...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    ...
    credit: {
      ...
      text: 'A girl walks towards the night sky by "ands//picociko"',
      url: "https://unsplash.com/illustrations/a-girl-walks-towards-the-night-sky-Gu_hYiE3v7g", // (Optional) URL link to the original artwork or artist's page
    },
  },
  toc: {
...
export const profileConfig: ProfileConfig = {
  ...
  links: [
    ...
    },
    {
      ...
      url: "https://www.linkedin.com/in/alyx-pink/",
    },
    {
      name: "Email",
