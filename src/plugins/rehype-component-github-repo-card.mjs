...
/**
 * Creates a GitHub Repository Card component.
 *
 * @param {Object} properties - The properties of the component.
 * @param {string} properties.repo - The GitHub repository in the format "owner/repo".
 * @param {import('mdast').RootContent[]} children - The children elements of the component.
 * @returns {import('mdast').Parent} The created GitHub Repository Card component.
 */
export function GithubRepoCardComponent(properties, children) {
  ...
  if (!repo || !repo.includes('/'))
    return h(
      'div',
      { class: 'hidden' },
      'Invalid GitHub repository. ("repo" attribute must be in the format "owner/repo")',
    )
